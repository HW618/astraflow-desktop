...
const (
	HealthService_CheckHealth_FullMethodName = "/astraflow.v1.HealthService/CheckHealth"
)
...
func (c *healthServiceClient) CheckHealth(ctx context.Context, in *CheckHealthRequest, opts ...grpc.CallOption) (*CheckHealthReply, error) {
...
func (UnimplementedHealthServiceServer) CheckHealth(context.Context, *CheckHealthRequest) (*CheckHealthReply, error) {
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "astraflow.v1.HealthService",
	...
	Metadata: "astraflow/v1/health.proto",
}
